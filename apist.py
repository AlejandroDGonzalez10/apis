...
st.sidebar.title("Seleccione plataforma de recomendacion")
platform = st.sidebar.selectbox("Plataforma", ['Inicio',"Amazon Prime Video", "Netflix", "Disney+",'Hulu'])
...
# Crea la aplicación de Streamlit
    ...
    user_id = st.text_input("ID de Usuario", int())
